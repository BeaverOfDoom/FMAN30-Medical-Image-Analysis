...
# Choose how many modes to keep based on input energy threshold
...
def main():
    ...
    # 1 - Manual segmentation (man_seg)
    show_manual_segmentation(man_seg, images)

    # Resample the manual seg to 14 points
    ...
    # 2 — GENERALIZED PROCRUSTES ALIGNMENT (GPA)
    print("\nRunning Generalized Procrustes Alignment on 40 shapes...")

    # Copying model to avoid modifying original data
    shapes_for_model = models.copy()
    ...
    # 4 — Segmentation with the Shape Model (ASM)
    print("\nRunning ASM segmentation on 5 test images (21–25)...")

    # Convert mean_vec back to complex mean shape for ASM
    mean_shape_cpx = vec_to_complex(mean_vec)

    # Segment images 21–25 
